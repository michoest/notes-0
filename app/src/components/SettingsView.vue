...
<template>
  <div class="max-w-2xl mx-auto p-4 lg:p-8">
      ...
      <div v-else>
        ...
        <div class="space-y-3">
          ...
          <div class="text-surface-400 text-sm space-y-2">
            <p><strong class="text-surface-300">On iOS:</strong> Tap the Share button in Safari, then "Add to Home Screen"</p>
            <p><strong class="text-surface-300">On Android:</strong> Tap the menu button in Chrome, then "Install app"</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="card p-6">
      ...
      <button 
        @click="clearAllData"
        class="btn bg-red-500/20 text-red-400 hover:bg-red-500/30 focus:ring-red-500"
      >
        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
